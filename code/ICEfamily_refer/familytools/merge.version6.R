...
#library(rlist)
print(file.path(scriptPath,"list_ice_family.rds"))
...
write.table(hmmout,file=paste(folder,"/",filename_order,"_dereplicated.txt",sep=""),quote=F,col.names=T,row.names=F,sep="\t")
...
classify_ice_family_yxl(list_ice_family[[x]][["familyname"]],list_ice_family[[x]][["orfname"]],list_ice_family[[x]][["idealORFcount"]],list_ice_family[[x]][["neighor"]],list_ice_family[[x]][["startORFname"]],list_ice_family[[x]][["secondstartORFname"]],list_ice_family[[x]][["endORFnamme"]],list_ice_family[[x]][["secondendORFname"]],filename_order,j)
}
}
...
write.table(icefinder_result,file=paste(folder,"/",filename_order,"_classification_summary.txt",sep=""),sep="\t",quote=F,row.names=F,col.names=T)
write.table(icefinder_result_modifi,file=paste(folder,"/",filename_order,"_classification_summary_modifi.txt",sep=""),sep="\t",quote=F,row.names=F,col.names=T)
}
