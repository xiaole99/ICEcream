...
mkdir ARG
cat list.arg.out.list.txt|while read line; do Rscript /autofs/bal21/xlyin/completegenome/ICEfinder_ICEfamily_refer/familytools/blastx_out_treatment_linux_20200828_3.R ${line} 70 80 /autofs/bal21/xlyin/completegenome/ICEfinder_ICEfamily_refer/familytools/structure_20200330_includingmutation.txt 1e-10; done
cd ..
